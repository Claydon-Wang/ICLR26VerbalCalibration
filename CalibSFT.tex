...
OLMo3-7B-Instruct~\citep{olmo2025olmo3} on DeepScaleR-Train, and present their
confidence distributions for correct and incorrect responses in
Figure~\ref{fig:initial_confidence_prior}.
...
\begin{figure}[t]
    ...
    normalized separately. High confidence persists even when answers
    are incorrect.}
...
The following proposition quantifies how little probabil–ity mass near
...
\begin{table*}[t]
    ...
    \begin{tabular}{lcccccccc}
        ...
        \rowcolor{calibrow} + CalibSFT & \textbf{65.14} & \textbf{87.76} & \textbf{11.18} & \textbf{10.26} & \textbf{46.34} & \textbf{75.98} & \textbf{21.52} & \textbf{18.41} \\
        \midrule
