...
16,384 tokens. Temperature is 0.6, with four responses per non-AIME question
...
\begin{table*}[!t]
\centering
\caption{Per-dataset results on the out-of-domain benchmarks. The evaluation
protocol matches Table~\ref{tab:appendix_id_results}.}
